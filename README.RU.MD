...
Модуль `ecos-crm` предлагает различные функции для оптимизации процессов продаж, такие как управление потенциальными клиентами, отслеживание возможностей, управление контактами и управление воронкой продаж.
...
Если вам нужна помощь или у вас есть вопросы по Citeck `ecos-crm`, то создайте issue в этом репозитории или обратитесь в нашу [службу поддержки](mailto:support@citeck.ru).

## Лицензия

Citeck `ecos-crm` распространяется под лицензией [GNU Lesser General Public License](LICENSE).
